...
async function main() {
    ...
    const compiledSierra = json.parse(fs.readFileSync( "./target/dev/mock_token_MockERC721.sierra.json").toString( "ascii"));
    const compiledCasm = json.parse(fs.readFileSync( "./target/dev/mock_token_MockERC721.casm.json").toString( "ascii"));
